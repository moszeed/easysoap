    ...
    function getWsdl(params, opts) {
        ...
        if (wsdlGetPromise[cacheFileName] === void 0) {
            wsdlGetPromise[cacheFileName] = new Promise(function(resolve, reject) {
                ...
                if (params.wsdlFileName) {
                    resolve(fs.readFileSync(params.wsdlFileName, 'UTF-8'));
                }
                else {
        ...
        return new Promise(function(resolve, reject) {
            ...
            getWsdl(params, opts)
                .done(function(wsdl) {
                    ...
                    var schema      = types ? searchNode(types[0], 'schema') : null;
                    ...
                    var getParams   = function(method, methodAttrName) {
                        ...
                        var elements    = [];
                        var methodNode  = types ? searchNodeByNameRecursive(types[0], method) : null;
