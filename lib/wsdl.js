(function() {
    ...
    Handler.prototype.get = function(params, opts) {

        opts = opts || {};

        if (params      === void 0) throw new Error('no params given');
        if (params.host === void 0) throw new Error('no host given');
        if (params.wsdl === void 0) throw new Error('no wsdl given');
        ...
        https.get({
            ...
            res.on('end',  function() { that.emit('get', wsdl); });
