(function () {
    ...
    var EasySoap = function(params, opts) {
        ...
        EasySoap.prototype.init = function() {
            ...
            if( this.params.port ) get_params.port = this.params.port;
        ...
        EasySoap.prototype.call = function(attrs, opts) {
            ...
            var methodAttrs = wsdl.requestCheck(attrs, this.wsdl, opts);
            attrs.SOAPAction = methodAttrs.action;
            attrs.methodNs = methodAttrs.schema;
